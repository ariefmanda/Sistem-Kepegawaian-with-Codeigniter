...
<div class="wrapper">
    ...
    <section class="content" style="margin:10px 10px 0px 10px; background-color:white;">
    	<div class="container">
        <h3 style="text-align:center;">Edit Jabatan</h3>
    <hr>
        	<form class="form-horizontal" method="POST" action="<?php echo base_url(); ?>index.php/jabatan/editkan/<?php echo $idJabatan; ?>" enctype="multipart/form-data">
    			   <div class="col-md-12">
                ...
                <input type="hidden" value="<?php echo $idDept; ?>" name="idDept">
                    ...
                    <div class="col-md-12">
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="col-md-7">
                                <input type="text" class="form-control" name="namaJabatan" placeholder="Nama Jabatan" value="<?php echo $namaJabatan; ?>" required>
                            </div>
                        </div>    
                        <br><br>
                        <div class="col-md-12">
